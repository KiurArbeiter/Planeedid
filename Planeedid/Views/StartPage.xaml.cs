    ...
    internal static class PlanetsService
    {
        private static List<Planet> planets = new()
        {
            ...
            new()
            {
                ...
                Subtitle = "  Oval dwarf",
                HeroImage = "humea.png",
                Description = "Haumea is an oval-shaped dwarf planet that is roughly the same size as Pluto. It is one of the fastest rotating " +
                "large objects in our solar system. The fast spin distorts Haumea's shape, making this dwarf planet look like a  " +
                "football. Everything we know about Haumea is from observations with ground-based telescopes from around " +
                "the world. ",
                AccentColorStart = Color.FromArgb("#0c293d"),
                AccentColorEnd = Color.FromArgb("#26abe0"),
                Images = new()
